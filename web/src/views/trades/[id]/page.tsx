          ...
          <Card className="py-4 gap-0">
            <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <StatItem label="Entry Price">
                <p className="text-foreground font-mono tabular-nums font-medium">{formatCurrency(trade.entryPrice)}</p>
              </StatItem>
              <StatItem label="Exit Price">
                <p className="text-foreground font-mono tabular-nums font-medium">{formatCurrency(trade.exitPrice)}</p>
              </StatItem>
              <StatItem label="P&L">
                {(() => {
                  ...
                  return (
                    <>
                      <p className={`text-lg font-mono font-bold tabular-nums ${pnlColor(net)}`}>
                        {formatCurrency(net)}
                      </p>
                      {comm > 0 && (
              ...
              <StatItem label="Quantity">
                <p className="text-foreground font-mono tabular-nums font-medium">{trade.quantity ?? 1}</p>
              </StatItem>
              ...
              <StatItem label="Opened">
                <p className="text-foreground font-mono text-xs tabular-nums">{formatDate(trade.openedAt)}</p>
              </StatItem>
              <StatItem label="Closed">
                <p className="text-foreground font-mono text-xs tabular-nums">{formatDate(trade.closedAt)}</p>
              </StatItem>
            </CardContent>
          </Card>
